...
type SliceBook struct {
	...
	Sections []*Book `protobuf:"bytes,1,rep,name=sections,proto3" json:"sections,omitempty"`
}

func (x *SliceBook) Reset() {
	*x = SliceBook{}
	if protoimpl.UnsafeEnabled {
...
func (x *SliceBook) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SliceBook) ProtoMessage() {}

func (x *SliceBook) ProtoReflect() protoreflect.Message {
	mi := &file_book_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SliceBook.ProtoReflect.Descriptor instead.
func (*SliceBook) Descriptor() ([]byte, []int) {
	return file_book_proto_rawDescGZIP(), []int{1}
}

func (x *SliceBook) GetSections() []*Book {
	if x != nil {
		return x.Sections
	}
	return nil
...
var file_book_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x22, 0x80, 0x01, 0x0a, 0x04, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x0e, 0x0a,
	...
	,
}
...
var file_book_proto_goTypes = []interface{}{
	(*Book)(nil),      // 0: module.Book
	(*SliceBook)(nil), // 1: module.SliceBook
}
var file_book_proto_depIdxs = []int32{
	0, // 0: module.SliceBook.sections:type_name -> module.Book
